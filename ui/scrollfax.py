...
class ScrollFaxView(ScrollView):
    ...
    def fillControls(self):
        ...
        if fax_enabled:
            ...
            self.addGroupHeading("recipient_quick_add", self.__tr("Quick Add a Recipient"))
            
            self.addRecipientQuickAdd()
            
            #self.addGroupHeading("options", "Fax Options")
            #self.addCopies()
            #self.addPageRange()
            #self.addPageSet()
            ...
            self.faxButton = self.addActionButton("bottom_nav", self.__tr("Send Fax Now"), 
                                    self.faxButton_clicked, s, self.funcButton_clicked)
    ...
    def addFileList(self):
        ...
        self.removeFilePushButton = PixmapLabelButton(widget, 
            "list-remove.png", "list-remove-disabled.png", name='')
        ...
        self.addWidget(widget, "file_list", maximize=False)
    ...
    def fileListView_rightButtonClicked(self, item, pos, col):
        ...
        popup.insertItem(self.__tr("Show File Types..."), self.showFileTypes_clicked)
        popup.popup(pos)
    ...
    def UpdateFileList(self):
        ...
        self.faxButton.setEnabled(non_empty_file_list)
    ...
    def addCoverpage(self):
        ...
        self.editCoverpagePushButton = QPushButton(widget,"editCoverpagePushButton")

        layout14.addWidget(self.editCoverpagePushButton,0,1)

        #self.addCoverpagePushButton = QPushButton(widget,"addCoverpagePushButton")
    ...
    def addRecipientList(self):
        ...
        self.moveDownPushButton = PixmapLabelButton(widget, 
            "down.png", "down-disabled.png", name='')
        ...
        self.recipientListView.addColumn(self.__tr("Fax #"))
        ...
        self.recipientListView.header().setLabel(0,self.__tr("Name/Group"))
        self.recipientListView.header().setLabel(1,self.__tr("Fax Number"))
        self.recipientListView.header().setLabel(2,self.__tr("Notes"))
        ...
        self.addWidget(widget, "recipient_list", maximize=True)
    ...
    def addRecipientAddFromFAB(self):
        ...
        self.textLabel1.setText(self.__tr("Add an <b>individual </b>from fax address book:"))
        self.textLabel2.setText(self.__tr("Add a <b>group</b> from fax address book:"))
    ...
    def addRecipientQuickAdd(self):
        ...
        #self.quickAddPushButton = QPushButton(widget,"quickAddPushButton")
        ...
        self.checkBox1 = QCheckBox(widget,"checkBox1")

        layout12.addMultiCellWidget(self.checkBox1,1,1,0,3)
        ...
        self.checkBox1.setText(self.__tr("Save Quick Add recipient in the Fax Address Book"))
